                                ...
                                <table class="w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="4"
                                                    class="flex items-center px-6 py-8 text-center text-gray-500">
                                                    No categories found.
                                                </td>
                                            </tr>
                                        @endforelse
    ...
    <div id="deleteModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            <div class="mt-3 text-center">
                ...
                <h3 class="text-lg leading-6 font-medium text-gray-900 mt-5">Delete Category</h3>
                <div class="mt-2 px-7 py-3">
                    <p class="text-sm text-gray-500">
                        Are you sure you want to delete "<span id="categoryName" class="font-semibold"></span>"?
        ...
        function openDeleteModal(categoryId, categoryName, productsCount) {
            ...
            if (productsCount > 0) {
                warningText.innerHTML =
                    `<br><strong class="text-red-600">Warning: This category has ${productsCount} product(s). You cannot delete it until all products are removed or reassigned.</strong>`;
            } else {
                warningText.innerHTML = '<br>This action cannot be undone.';
            }
        }
